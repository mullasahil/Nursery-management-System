...
def index(request):
    ...
    # return HttpResponse("<h1 align='center'> <font color='#FF0000' size='9' > Welcome To Go Green </font> </h1>")
...
def checkout(request):
    if request.method == "POST":
        ...
        if 'onlinePay' in request.POST:
            ...
            Aniket_dict['CHECKSUMHASH'] = Checksum.generate_checksum(Aniket_dict, MERCHANT_KEY)
            return render(request, 'shop/paytm.html', {'darshan_dict': Aniket_dict})
